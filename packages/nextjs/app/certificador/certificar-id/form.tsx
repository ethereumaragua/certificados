...
export function Componente() {
  ...
  const transaccion = async (usuarioPais: any, usuarioId: any, usuarioNombre: any, categoria: number, curso: number, nombreCertificador: string) => {
    try {
      await certificarId(
        {
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Este es el nombre del Certificador del Curso.
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
            ...
            <div>
              ...
              <FormDescription>
                Datos de los usuarios a certificar.
              </FormDescription>
