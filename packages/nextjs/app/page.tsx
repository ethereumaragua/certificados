...
const Home: NextPage = () => {
  ...
  const outerCardStyle = "w-full sm:w-1/3 md:w-1/5 hover:transform hover:scale-105 hover:shadow-xl transition duration-100 ease-in-out cursor-pointer min-w-[180px]";
